...
Write-Host "new: $new"
Write-Host "install_tfs: $install_tfs"
Write-Host "install_versionone_v1auth: $install_versionone_v1auth"
Write-Host "install_versionone_wauth: $install_versionone_wauth"
